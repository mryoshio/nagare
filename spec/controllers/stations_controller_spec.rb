...
describe StationsController do
  ...
  let(:valid_attributes) { { "place_id" => "1" } }
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested station" do
        ...
        Station.any_instance.should_receive(:update).with({ "place_id" => "1" })
        put :update, {:id => station.to_param, :station => { "place_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the station as @station" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Station.any_instance.stub(:save).and_return(false)
        put :update, {:id => station.to_param, :station => { "place_id" => "invalid value" }}, valid_session
        assigns(:station).should eq(station)
      end
